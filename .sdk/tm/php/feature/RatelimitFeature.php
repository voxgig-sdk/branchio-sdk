...
// Branchio SDK ratelimit feature
...
class BranchioRatelimitFeature extends BranchioBaseFeature
{
    ...
    private function _acquire(BranchioContext $ctx): void
    {
    ...
    private function _track(BranchioContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
