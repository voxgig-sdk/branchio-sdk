...
// Branchio SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BranchioSDK::test)
...
{
    private const SDK_CLASS = 'BranchioSDK';
    ...
    private const SDK_BASE = 'branchio_sdk';
