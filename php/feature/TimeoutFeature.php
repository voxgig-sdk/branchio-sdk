...
class BranchioTimeoutFeature extends BranchioBaseFeature
{
    ...
    private function _with_timeout(BranchioContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BranchioContext $_ctx, float $ms): void
    {
        $client = $this->client;
