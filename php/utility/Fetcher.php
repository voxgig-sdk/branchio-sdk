...
// Branchio SDK utility: fetcher

class BranchioFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BranchioSDK/1.0)';
    ...
    public static function call(BranchioContext $ctx, string $fullurl, array $fetchdef): array
    {
