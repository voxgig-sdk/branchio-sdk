...
function envOverride(m) {
    if ('TRUE' === process.env.BRANCHIO_TEST_LIVE ||
        'TRUE' === process.env.BRANCHIO_TEST_OVERRIDE) {
    ...
    m.BRANCHIO_TEST_EXPLAIN = process.env.BRANCHIO_TEST_EXPLAIN || m.BRANCHIO_TEST_EXPLAIN;
    return m;
}
