...
func registerSDKWords(r *eng.Registry, client *sdk.BranchioSDK) {
...
func runOp(client *sdk.BranchioSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
