...
class BranchioGraphql
{
    ...
    // equivalent.
    public static function body(BranchioContext $ctx): mixed
    {
    ...
    public static function errors(BranchioContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
