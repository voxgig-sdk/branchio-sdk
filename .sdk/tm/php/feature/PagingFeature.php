...
class BranchioPagingFeature extends BranchioBaseFeature
{
    ...
    private function _graphql_pre_request(BranchioContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(BranchioContext $ctx): bool
    {
