...
// Branchio SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class BranchioMakeRequest
{
    public static function call(BranchioContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new BranchioResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new BranchioResponse($fetched);
        } else {
