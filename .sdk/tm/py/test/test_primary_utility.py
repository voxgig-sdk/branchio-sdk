...
from projectname_sdk import BranchioSDK
from projectname_sdk.core.spec import BranchioSpec
from projectname_sdk.core.result import BranchioResult
from projectname_sdk.core.response import BranchioResponse
from projectname_sdk.core.operation import BranchioOperation
from projectname_sdk.core.error import BranchioError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import BranchioBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = BranchioSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = BranchioSDK.test(None, None)
        ...
        class TestInitFeature(BranchioBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(BranchioBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = BranchioSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = BranchioSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = BranchioSDK.test(None, setup_opts)
