...
from branchio_sdk.utility import register

# Load features
from branchio_sdk.feature.base_feature import BranchioBaseFeature
from branchio_sdk.features import _has_feature, _make_feature
...
class BranchioSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = BranchioUtility()
        self._utility = utility

        from branchio_sdk.config import shared_config
    ...
    def get_utility(self):
        return BranchioUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("BranchioSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Url(self, data=None) -> "UrlEntity":
        ...
        from branchio_sdk.entity.url_entity import UrlEntity
        return UrlEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "BranchioSDK":
        if sdkopts is None:
            sdkopts = {}
