# Branchio SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BranchioSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BranchioSDK(...) and BranchioSDK.test(...) become
#      BranchioSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "branchio_sdk"
_SDK_CLASS = "BranchioSDK"
