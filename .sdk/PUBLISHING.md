...
|---|---|---|
| `js/` | @voxgig-sdk/branchio-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/branchio | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/branchio-js \
      --repository voxgig-sdk/branchio-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/branchio-js` shows it, and
`npm trust revoke @voxgig-sdk/branchio-js --id=<id>` removes it.
