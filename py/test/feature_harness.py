# Branchio SDK feature test harness
#
...
from branchio_sdk.features import _make_feature
...
class _Ctx:
    ...
    def __init__(self, client, utility, op=None, entity=None, ctrl=None):
        ...
        self.out = {}
        self.ctrl = ctrl if ctrl is not None else BranchioControl()
        self.meta = {}
        self.op = op
        self.entity = entity
