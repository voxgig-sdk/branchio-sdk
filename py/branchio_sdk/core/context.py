...
from branchio_sdk.core.control import BranchioControl
...
from branchio_sdk.core.helpers import get_ctx_prop, to_map
...
class BranchioContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, BranchioResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BranchioResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return BranchioError(code, msg, self)
