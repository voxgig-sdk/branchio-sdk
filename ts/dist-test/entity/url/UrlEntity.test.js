...
(0, node_test_1.describe)('UrlEntity', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('BRANCHIO_TEST_LIVE'));
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.BranchioSDK.test();
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != url_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    let client = __1.BranchioSDK.test(options, extra);
    ...
    const idmapEnvVal = process.env['BRANCHIO_TEST_URL_ENTID'];
    ...
    if (live) {
        client = new __1.BranchioSDK(merge([
