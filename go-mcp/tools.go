...
type Args struct {
	Entity string         `json:"entity" jsonschema:"url"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.BranchioSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "branchio_list",
		Description: "List records from Branchio. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "branchio_load",
		Description: "Load a single record from Branchio. " +
...
func runOp(client *sdk.BranchioSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.BranchioSDK, name string) (sdk.BranchioEntity, error) {
