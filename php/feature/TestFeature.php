...
// Branchio SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class BranchioTestFeature extends BranchioBaseFeature
{
    ...
    public function init(BranchioContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (BranchioContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (BranchioContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(BranchioContext $ctx, $op, $args): array
    {
