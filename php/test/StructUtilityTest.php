...
// Branchio SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = BranchioOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(BranchioOmni::structfix($now, Struct::undef()))
                        !== json_encode(BranchioOmni::structfix($val, Struct::undef()))) {
