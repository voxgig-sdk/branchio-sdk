...
// Branchio SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class BranchioParam
{
    public static function call(BranchioContext $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = BranchioHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {
